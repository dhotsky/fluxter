...
part of '../../../core/network/api_service.dart';
...
class _ApiService implements ApiService {
  ...
  @override
  Future<ApiResponse<LoginData>> login(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<ApiResponse<LoginData>>(
